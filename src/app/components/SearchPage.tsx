...
export default function SearchPage({ type, searchAction }: SearchPageProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[75vh] w-full px-4 py-12">
      <div className="relative w-full max-w-3xl">
        {/* Decorative background glow - Removed animate-pulse for a static elegant glow */}
        <div className="absolute -inset-6 bg-gradient-to-r from-sky-500/10 to-indigo-500/10 rounded-[4rem] blur-3xl pointer-events-none" />
        ...
        <div className="relative flex flex-col items-center px-8 md:px-16 py-16 glass w-full rounded-[3rem] border border-white/10 shadow-2xl backdrop-blur-3xl bg-slate-900/60 overflow-hidden">
          ...
          <div className="relative z-10 w-full text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-b from-white to-slate-400 bg-clip-text text-transparent tracking-tighter">
              Search {type}
            </h1>
