...
export default function SearchFormComponent(props: props) {
  const { lang } = useLanguage();
  const textPlaceholder = lang === 'en' ? 'Type a title...' : 'Escribe un título...';
  const textButton = lang === 'en' ? 'Search' : 'Buscar';
